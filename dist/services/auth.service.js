...
exports.sendForgotPasswordEmail = exports.setResetToken = exports.createRandomToken = exports.sendResetPasswordEmail = exports.resetPassword = exports.createUser = void 0;
...
const createUser = (userObj) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user;
    if (userType === "Student") {
        const _college = yield college_1.default.findOne({ where: { name: college } });
        const _department = yield department_1.default.findOne({ where: { name: department } });
    ...
    sendMail_1.default([user.email], "SIGN UP SUCCESFULL", `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html
...
const resetPassword = (token, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user.password = bcrypt_nodejs_1.default.hashSync(password, bcrypt_nodejs_1.default.genSaltSync(10));
...
const setResetToken = (email, token) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendForgotPasswordEmail = (user, token, host) => __awaiter(void 0, void 0, void 0, function* () {
    const resetLink = `http://${host}/reset/${token}`;
    yield sendMail_1.default([user.email], "", "Reset your password", `You are receiving this email because you (or someone else) have requested the reset of the password for your account.\n\n
