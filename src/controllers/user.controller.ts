...
export const createUser = async (userObj: any): Promise<void> => {
	const {
		email,
		password,
		college,
...
export const postReset = async (
	...
	async.waterfall(
		[
			async function resetPassword(done: (err: any, user: UserDocument) => void) {
				try {
